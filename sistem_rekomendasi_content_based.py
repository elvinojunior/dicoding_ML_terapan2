# -*- coding: utf-8 -*-
"""Sistem Rekomendasi : Content based.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1n0Pq6BtxvdNhl5iEfeVriTZPFH3KgyfZ
...
"""Setelah mengecek ringkasan informasi pada dataset dapat diketahui bahwa telah bersih
...
# Membuat dataframe simalarity untuk evaluasi model
...
sns.heatmap(similarity_df.iloc[:10, :10],
            cmap='viridis',
            annot=True,
            fmt=".2f",
            linewidths=0.5)
plt.title("Similarity Matrix antar Film (Top 10) dengan Nilai Cosine Similarity")
plt.show()
...
"""Rata-rata precision@5 sekitar 48% dari 5 rekomendasi teratas yang diberikan oleh sistem Anda 2 sampai 3 di antaranya adalah relevan bagi pengguna. Ini menunjukkan bahwa sistem rekomendasi memiliki kemampuan yang lumayan untuk mendapatkan rekomendasi film dengan genre, deskripsi, dan judul yang mirip
